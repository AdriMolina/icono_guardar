#include "stdafx.h"  //________________________________________ ejemplo2_0.cpp
#include "ejemplo2_0.h"

int APIENTRY wWinMain(HINSTANCE hInstance, HINSTANCE, LPTSTR cmdLine, int cmdShow) {
	ejemplo2_0 app;
	return app.BeginDialog(IDI_ejemplo2_0, hInstance);
}

void ejemplo2_0::Window_Open(Win::Event& e)
{
	...
	toolb1.imageList.Create(pixelsIconSize, pixelsIconSize, 7);//<< EDIT HERE THE NUMBER OF IMAGES
...
void ejemplo2_0::Cmd_Save(Win::Event& e)
{
	Win::FileDlg dlg;
	dlg.Clear();
...
void ejemplo2_0::Window_Close(Win::Event& e)
{
	//this->Destroy(); // Use this to close and destroy the Window
}

void ejemplo2_0::Window_Help(Win::Event& e)
{
}

void ejemplo2_0::Cmd_Copy(Win::Event& e)
{
}
